 ...
 * should be properly formatted to track as a time. We may also display the attributes of the related
...
class CGridView extends CBaseListView
{
	 ...
	 * Note that in order to track an input field for filtering, a column must have its {@link CDataColumn::name}
