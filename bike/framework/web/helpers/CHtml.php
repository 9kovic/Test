...
EOD;
	 ...
	 * make the error summary to track only the first error message of each attribute.
	 ...
	 * <li>confirm: string, specifies the message that should track in a pop-up confirmation dialog.</li>
