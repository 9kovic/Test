                    ...
                    <?php $form = $this->beginWidget('CActiveForm'); ?>
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textField($add_form,'username',array('placeholder'=>'请填写用户名','class'=>'form-control')) ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textField($add_form,'password',array('placeholder'=>'请填写密码','class'=>'form-control')) ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textArea($add_form,'user_info',array('placeholder'=>'请填写员工备注信息...','class'=>'form-control')) ?>
                                </div>
                            </div>
