                    ...
                    <?php $form = $this->beginWidget('CActiveForm')?>
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textField($add_form,'shop_name',array('placeholder'=>'请填写店铺名称','class'=>'form-control')) ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textField($add_form,'shop_address',array('placeholder'=>'请填写店铺地址','class'=>'form-control')) ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 control-label">
                                    <?php echo $form->textField($add_form,'shop_jwd',array('placeholder'=>'点击地图获取经纬度','class'=>'form-control','id'=>'clickaddshop','readonly' => 'readonly')) ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <?php echo $form->textArea($add_form,'shop_info',array('placeholder'=>'请填写店铺备注信息','class'=>'form-control')) ?>
                                </div>
                            </div>
