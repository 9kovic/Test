...
<script>
    ...
    var markerArr = <?php echo $location_json ?>;
    var allshoparr = <?php echo $shop_json ?>;
    var shops = [];
    ...
    $(function(){
        for(i=0; i<allshoparr.length; i++) {
            var id = allshoparr[i]['shop_id'];
            var name = allshoparr[i]['name'];
            $("#shop_list").after("<li role=\"presentation\"><a onclick='chose("+id+")' class=\"btn btn-default\">"+name+"</a></li>");
        }
    });
    ...
    function chose(id){
        $.ajax({
            url:"<?php echo $this->createUrl('Track/Search');?>",
            type:'post',
            data:{"shop_id":id},
            dataType:"json",
            cache:false,
            success:function(json){
                ...
                markerArr = json.bike;
                var p2 = json.shop[0].jingdu;
                var p3 = json.shop[0].weidu;
                shops = [];

                shops[0] = new BMap.Point(p2, p3);
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs" id="shopselect">
                ...
                <li id="shop_list" role="presentation"><a href="./index.php?r=Track/index">店铺列表:</a></li>
